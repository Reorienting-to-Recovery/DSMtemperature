...
# https://cdec.water.ca.gov/dynamicapp/staMeta?station_id=jlf
...
write_rds(redbluff_water_temp_c, 'data-raw/upper_sacramento_river/upper_sacramento_river_water_temp_c.rds')
